cask "ai-env-setup" do
  ...
  url "file://#{File.expand_path("../Artifacts/ai-env-setup-v#{version.csv.first}-build#{version.csv.second}.zip", __dir__)}"
  name "AI Env Setup"
  desc "Manage MCP, skills, commands, and model providers across AI clients"
  homepage "https://github.com/instasergio/ai-env-setup"
